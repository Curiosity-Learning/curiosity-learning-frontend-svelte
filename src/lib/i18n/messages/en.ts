const en = {
	...
	settingsPage: {
		...
		notificationsSessionChangesLabel: 'Session changes',
	...
	clubSettingsPage: {
		...
		notFoundDescription: "This club doesn't exist or you don't have access to it.",
		accessDeniedTitle: 'Access denied',
		accessDeniedDescription:
			'Only club members with the club:edit permission can change club settings.',
		saveErrorTitle: 'Unable to save settings',
		saveSuccessTitle: 'Saved',
		saveSuccessDescription: 'Club settings updated.',
		nameRequired: 'Club name is required.',
		permissionDenied: 'You do not have permission to edit this club.',
		detailsTitle: 'Club details',
		detailsDescription:
			'These details are visible to members and are editable through the club permission model.',
		nameLabel: 'Club name',
		...
		resetCodeConfirmTitle: 'Reset invite code?',
		resetCodeConfirmDescription:
			'The current invite code will stop working immediately. Anyone who has not yet joined with it will need the new code.',
		resetCodeConfirmAction: 'Reset code',
		resetCodeCancel: 'Cancel',
		resetCodeSuccess: 'Invite code reset.',
		resetCodeFailure: 'Unable to reset invite code.',
		saveButton: 'Save club settings',
		saving: 'Saving...',
		scheduleTitle: 'Schedule',
		scheduleDescription: 'Add the days, times, and locations this club regularly meets.',
		scheduleEmpty: 'No schedule slots yet.',
		addSlotButton: 'Add schedule slot',
		editSlotTitle: 'Edit schedule slot',
		addSlotTitle: 'Add schedule slot',
		dayLabel: 'Day of week',
		startTimeLabel: 'Start time',
		endTimeLabel: 'End time',
		slotLocationLabel: 'Location',
		slotLocationPlaceholder: 'Address, description, or meeting URL',
		slotSave: 'Save',
		slotCancel: 'Cancel',
		slotRemove: 'Remove',
		slotRemoveConfirm: 'Remove this schedule slot?',
		slotEndAfterStart: 'End time must be after start time.',
		slotLocationRequired: 'Location is required.',
		slotSaveFailure: 'Unable to save schedule slot.',
		slotRemoveFailure: 'Unable to remove schedule slot.',
		days: {
			monday: 'Monday',
			tuesday: 'Tuesday',
			wednesday: 'Wednesday',
	...
	membersPage: {
		...
		guideCountSingular: '1 guide',
		guideCountPlural: '{count} guides',
		learnerCountSingular: '1 learner',
		learnerCountPlural: '{count} learners',
		inviteAction: 'Invite',
		guidesSectionTitle: 'Guides',
		learnersSectionTitle: 'Learners',
		joinedOn: 'Joined {date}',
		noGuidesMatch: 'No guides matched your search.',
		noLearnersMatch: 'No learners matched your search.',
		noLearnersYetTitle: 'No learners yet',
		noLearnersYetDescription: 'Invite learners to get this club started.',
		noSearchResultsTitle: 'No members found',
		noSearchResultsDescription: 'Try a different name, role, or username.'
	},
	inviteLearnerDialog: {
	...
	projectDetail: {
		...
		inviteDialogDescription: 'Search by username to invite someone to this project.',
		inviteSearchPlaceholder: 'Search by username...',
		inviteSearchNoResults: 'No matching users found.',
		inviteSendAction: 'Invite',
		inviteSendingAction: 'Inviting...',
		inviteSendFailure: 'Failed to send invite.',
		pendingInvitesTitle: 'Pending invites',
		pendingInvitesEmpty: 'No pending invites.',
		cancelInviteAction: 'Cancel',
		cancelInviteFailure: 'Failed to cancel invite.',
		invitedByYouLabel: 'Invited by you',
		yourInviteBannerTitle: "You've been invited to this project",
		yourInviteBannerDescription: '{inviterName} invited you to join this project.',
		acceptInviteAction: 'Accept',
		declineInviteAction: 'Decline',
		inviteDecisionFailure: 'Failed to update this invite.',
		requestToJoinAction: 'Request to join',
		requestToJoinSending: 'Requesting...',
		requestToJoinFailure: 'Failed to request to join.',
		requestPendingLabel: 'Request pending',
		cancelRequestAction: 'Cancel request',
		cancelRequestFailure: 'Failed to cancel your request.',
	...
	parentAccounts: {
		...
		linkedChildrenDescription: 'View a read-only summary of clubs, projects, and chats.',
		linkedChildrenEmpty: 'No linked children yet.',
		viewAsAction: 'View as {name}',
		linkedParentTitle: 'Linked parent',
		linkedParentDescription: 'A parent or guardian can view a read-only summary of your activity.',
		linkedParentNone: 'No parent is currently linked to your account.',
		unlinkAction: 'Unlink parent',
		unlinkConfirmTitle: 'Unlink parent account?',
		unlinkConfirmDescription:
			'Your parent will no longer be able to view your clubs, projects, or chats.',
		unlinkConfirmAction: 'Unlink',
		unlinkCancel: 'Cancel',
		unlinkFailure: 'Unable to unlink parent account.',
		unlinkSuccess: 'Parent account unlinked.',
		bannerLabel: 'Viewing as {name} — read-only',
		exitAction: 'Back to settings',
		overviewTab: 'Overview',
		chatsTab: 'Chats',
		clubsTitle: 'Clubs',
		clubsEmpty: 'Not a member of any clubs yet.',
		currentProjectsTitle: 'Current projects',
		currentProjectsEmpty: 'No current projects yet.',
		showcaseProjectsTitle: 'Showcase',
		showcaseProjectsEmpty: 'No showcase projects yet.',
		updatesTitle: 'Recent updates',
		updatesEmpty: 'No updates yet.',
		roomsEmpty: 'No chats yet.',
		noMessages: 'No messages yet.',
		loadErrorTitle: 'Could not load this child account',
		notFoundTitle: 'Not accessible',
		notFoundDescription: "This child account isn't linked to your account.",
		selectChatPrompt: 'Select a chat to view its messages.'
	},
	feedback: {
