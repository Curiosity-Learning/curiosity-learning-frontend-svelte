...
| ----------------- | --------------------------------------- | ----------------------------------------------------------------------- | ------------------------------------ |
| `profiles`        | Per-user profile and onboarding state   | `userId`, `email`, `username?`, `profileImageMediaAssetId?`, `activeClubId?`, `isVerified`, `firstLoginCompleted`, `pendingClubCode?`, `pendingRole?` | `by_user_id`, `by_email`, `by_username`, `by_profile_image_media_asset` |
