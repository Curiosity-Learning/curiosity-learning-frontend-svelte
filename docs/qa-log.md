...
- 2026-03-29: Reintroduced lightweight public-page i18n on CL-744 with English and Dutch message bundles, shared public auth/onboarding language switching, and translated copy across the public onboarding/auth flow without adding a heavier translation library back to the branch.
